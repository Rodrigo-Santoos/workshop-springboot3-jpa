package com.educandoweb.Curso.Spring.Boot.config;
...
import com.educandoweb.Curso.Spring.Boot.entities.enums.OrderStatus;
import com.educandoweb.Curso.Spring.Boot.repositories.CategoryRepository;
import com.educandoweb.Curso.Spring.Boot.repositories.OrderItemRepository;
...
//clase de configuraçao para instaciar o banco de dados para gente
...
public class TestConfig implements CommandLineRunner{
	...
	//========================================================================================
	//tudo aqui dentro execulta quando a aplicaçao for iniciada
	@Override
	public void run(String... args) throws Exception {
		...
		//associando as categorias com a tabela de associaçao tb_product_category
